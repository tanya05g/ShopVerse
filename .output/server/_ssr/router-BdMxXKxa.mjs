...
function AppProvider({ children }) {
  const [cart, setCart] = reactExports.useState(() => read("sv_cart", []));
  const [wishlist, setWishlist] = reactExports.useState(() => read("sv_wishlist", []));
  const [recentlyViewed, setRecentlyViewed] = reactExports.useState(() => read("sv_recent", []));
  const [theme, setTheme] = reactExports.useState(() => read("sv_theme", "light"));
  const [user, setUser] = reactExports.useState(() => read("sv_user", null));
  const [addresses, setAddresses] = reactExports.useState(() => read("sv_addresses", []));
  const [orders, setOrders] = reactExports.useState(() => read("sv_orders", []));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppContext.Provider, { value: api, children });
}
const useApp = () => {
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "btn-brand", children: "Go home" }) })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "We hit a snag loading this page. Try again or head back home." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap justify-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
        router2.invalidate();
        reset();
      }, className: "btn-brand", children: "Try again" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "btn-outline-dark", children: "Go home" })
    ] })
  ] }) });
}
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AppProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, {})
  ] }) });
}
const $$splitComponentImporter$f = () => import("./wishlist-DshH4G9e.mjs");
...
const $$splitComponentImporter$e = () => import("./terms-BMCUWbbP.mjs");
...
const $$splitComponentImporter$d = () => import("./shop-BDU8DICh.mjs");
...
const $$splitComponentImporter$c = () => import("./register-CkiJDhrJ.mjs");
...
const $$splitComponentImporter$b = () => import("./privacy-DxFzLOyY.mjs");
...
const $$splitComponentImporter$a = () => import("./order-confirmation-DemmAaBO.mjs");
...
const $$splitComponentImporter$9 = () => import("./login-n4Xk_p5X.mjs");
...
const $$splitComponentImporter$8 = () => import("./forgot-password-BF5IPoJ5.mjs");
...
const $$splitComponentImporter$7 = () => import("./faq-BqMgne9k.mjs");
...
const $$splitComponentImporter$6 = () => import("./dashboard-DLcmVxX-.mjs");
...
const $$splitComponentImporter$5 = () => import("./contact-B-Zww_m9.mjs");
...
const $$splitComponentImporter$4 = () => import("./checkout-BY22CeVR.mjs");
...
const $$splitComponentImporter$3 = () => import("./cart-DG2emCjn.mjs");
...
const $$splitComponentImporter$2 = () => import("./about-AuLgJ1Y3.mjs");
...
const $$splitComponentImporter$1 = () => import("./index-D9r53_9D.mjs");
...
const $$splitComponentImporter = () => import("./product._id-CIbpG0R6.mjs");
const $$splitNotFoundComponentImporter = () => import("./product._id-DH2WzVTP.mjs");
